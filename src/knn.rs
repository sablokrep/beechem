...
pub fn classifyadd(
    ...
    let randomvalue =
        RandomForestClassifier::fit(&valueinput.0, &valueinput.1, Default::default()).unwrap();
    ...
    let randomtest =
        RandomForestClassifier::fit(&splitratio.0, &splitratio.2, Default::default()).unwrap();
    ...
    Ok("The classifier has been completed".to_string())
}
